...
public class T02EnumTest {
	...
	//데이터값을 정해 줄 경우에는 생성자를 만들어서 괄호 속의 값이 변수에 저장되도록 
	//해야한다.
	public enum Season{
	...
	public static void main(String[] args) {
		...
		// 열거형 객체변수에 값을 저장하기
			...
			for(City city : City.values()) {
				...
				System.out.println(city1 == City.대전);
				System.out.println(city1 == City.대구);
				
				//System.out.println(City.대구 == HomeTown.대구);
				
				System.out.println("대구=>" + city1.compareTo(City.대구));
				System.out.println("서울=>" + city1.compareTo(City.서울));
				System.out.println("대전=>" + city1.compareTo(City.대전));
			}
